...
function start(){
	...
	let arrup=document.querySelector('.arrow_up');
	let arrdown=document.querySelector('.arrow_down');
	let arrright=document.querySelector('.arrow_right');
	let arrleft=document.querySelector('.arrow_left');
  ...
  function keyDownR(){
	...
	function gamePlay(){
		 ...
		 if(player.start){
			  ...
			  moveLines();
			  moveCar(car);
			  if(ArrowUp=true && player.y>(road.top+70)){
					player.y-=player.speed;
			  }
			  if(ArrowDown=true && player.y<(road.bottom-70)){
					player.y+=player.speed;
			  }
			  if(ArrowLeft=true && player.x>0){
					player.x-=player.speed;
			  }
			  if(ArrowRight=true && player.x<(road.width+60)){
					player.x+=player.speed;
			  }
